...
[![Build Status](https://travis-ci.org/btcziggurat/btcwallet.png?branch=master)](https://travis-ci.org/btcziggurat/btcwallet)
...
can be found [here](https://github.com/btcziggurat/btcd).  An alternative
...
https://github.com/btcziggurat/btcd/releases

https://github.com/btcziggurat/btcwallet/releases
...
```
git clone https://github.com/btcziggurat/btcwallet $GOPATH/src/github.com/btcziggurat/btcwallet
cd $GOPATH/src/github.com/btcziggurat/btcwallet
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/btcziggurat/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/btcziggurat/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/btcziggurat/btcwallet/issues)
