...
[![GoDoc](https://godoc.org/github.com/btcziggurat/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/btcziggurat/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/btcziggurat/btcwallet/walletdb

## Installation

```bash
$ go get github.com/btcziggurat/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/btcziggurat/btcwallet/walletdb#example-package--BasicUsage)  
